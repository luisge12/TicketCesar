...
export default function BlogArticle() {
  ...
  useEffect(() => {
    ...
    setArticle(null);
  fetch(`http://localhost:3000/get-article-by-id/${id}`)
      .then(res => {
  ...
  return (
    <div className="blog-article-main">
      <nav className="blog-nav" style={{ width: '100%' }}>
        ...
        <button className="blog-nav-btn" disabled>Artículo</button>
      </nav>
  ...
  <img className="blog-article-image" src={article.images} alt={article.title} />
